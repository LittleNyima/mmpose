...
class AnimalFishDataset(Kpt2dSviewRgbImgTopDownDataset):
    """AnimalFishDataset for animal pose estimation.

    Modified from `AnimalFlyDataset`.
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/fish.py')
